...
describe Chat::Mailer do
  ...
  describe "for chat mentions" do
    fab!(:mention) { Fabricate(:user_chat_mention, user: user_1, chat_message: chat_message) }
    ...
    it "queues the job if the user has unread mentions and already read all the messages in the previous summary" do
      ...
      Fabricate(:user_chat_mention, user: user_1, chat_message: unread_message)
    ...
    it "doesn't mix mentions from other users" do
      ...
      Fabricate(:user_chat_mention, user: user_2, chat_message: new_message)
